...
export default function App(){
  ...
  return<div data-theme={theme}style={{minHeight:"100vh",background:currentAccount?.slug==="clara"?`linear-gradient(rgba(255,182,193,0.06) 0%, rgba(255,182,193,0.06) 100%), ${T.bg}`:T.bg,fontFamily:T.font,color:T.text}}>
